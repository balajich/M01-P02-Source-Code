...
class VirtualNodeMap:
    ...
    def populate_map(self):
        ...
        step_size = self._TOTAL_VIRTUAL_NODES/ len(self._node_names)
        virtual_node_ids = [i for i in range(self._TOTAL_VIRTUAL_NODES)]
        # distribute the virtual_node_ids to nodenames
        for i in  range(len(virtual_node_ids)):
